...
public class RunStatusCrudService extends TemplateCrudService<RunStatus, Long> {
	...
	@Inject
	public RunStatusCrudService(ConnectionSource connection, Dao<RunStatus, Long> taskRunStatusDao) {
		super(connection);
